...
import com.example.noteappdb.NoteApplication
import com.example.noteappdb.R
import com.example.noteappdb.adapters.NoteAdapter
import com.example.noteappdb.model.Note
import com.example.noteappdb.viewmodel.NoteViewModel
import com.example.noteappdb.viewmodel.NoteViewModelFactory
...
class MainActivity : AppCompatActivity() {
    ...
    fun showDialogMessage() {
        ...
        dialogMessage.setMessage(
            "by clicking on Yes all notes will delete" + ", for deleting specific note, please swipe left or right."
        )
